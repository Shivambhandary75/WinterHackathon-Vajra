...
const InstitutionLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Institution login submitted:', formData);
    
    // Set institution user flag in localStorage
    localStorage.setItem('userType', 'institution');
    localStorage.setItem('institutionId', formData.institutionId);
    localStorage.setItem('institutionEmail', formData.email);
    ...
    <div className="min-h-screen bg-linear-to-br from-[#28363D] via-[#2F575D] to-[#6D9197] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#CEE1DD]">Secure access for authorized institutions</p>
        </div>
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                />
                <span className="ml-2 text-sm text-[#6D9197]">Keep me signed in</span>
              </label>
              <Link to="/institution-forgot-password" className="text-sm text-[#658B6F] hover:text-[#6D9197] transition-colors">
                Reset password
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#6D9197]">
              ...
              <Link to="/institution-register" className="text-[#658B6F] hover:text-[#6D9197] font-semibold transition-colors">
                Request Access
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 border-t border-[#CEE1DD] pt-6">
            <p className="text-xs text-center text-[#99AEAD]">
              Regular user?{' '}
              <Link to="/login" className="text-[#658B6F] hover:text-[#6D9197] transition-colors">
                Login here
              </Link>
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 text-white">
            ...
            <div>
              ...
              <p className="text-xs text-[#CEE1DD]">
                This portal is restricted to verified institutions only. All access is logged and monitored for security.
              </p>
            </div>
          </div>
        </div>
