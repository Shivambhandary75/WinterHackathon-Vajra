...
const institutionSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ['POLICE', 'MUNICIPAL', 'DISASTER', 'FIRE', 'HEALTH', 'FOREST', 'ADMIN'],
      default: function() {
...
institutionSchema.methods.getStatistics = function () {
  return {
    ...
    resolutionRate: this.statistics.reportsHandled > 0 
      ? ((this.statistics.reportsResolved / this.statistics.reportsHandled) * 100).toFixed(2)
      : 0
  };
};
